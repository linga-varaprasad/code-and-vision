...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function isWebGL2(context: GLContext): context is WebGL2RenderingContext {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      // Use conditional typing to handle WebGL1 vs WebGL2
    ...
    function getSupportedFormat(gl: GLContext, internalFormat: number, format: number, type: number | null) {
    ...
    function supportRenderTextureFormat(gl: GLContext, internalFormat: number, format: number, type: number | null) {
    ...
    function drawDisplay(target: any) {
      ...
      gl.uniform1f(displayMaterial.uniforms.opacity, 1.0);
    ...
    canvas.addEventListener("mousedown", (e) => {
      ...
      updatePointerDownData(pointers[0], posX, posY);
    });
    ...
    canvas.addEventListener("touchstart", (e) => {
      ...
      for (let i = 0; i < touches.length; i++) {
        ...
        updatePointerDownData(pointers[i], posX, posY);
      }
    });
    ...
    function updatePointerDownData(pointer: any, posX: number, posY: number) {
      pointer.id = -1;
      pointer.down = true;
      pointer.moved = false;
